...
export const DropdownCombobox: React.FC<DropdownComboboxProps> = ({initialSelectedItem, items, placeholder, onSelectedItemChange}) => {
  ...
  return (
    <div className='pachyderm-DropdownCombobox' >
      ...
      <ul
        {...getMenuProps()}
        data-testid="DropdownCombobox-ul"
      >
        {(isOpen || !selectedItem) &&
